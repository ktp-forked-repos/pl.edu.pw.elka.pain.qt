...
//    Planet* sun = new Planet(695700, 330000, 0, 0, 0, "Sun", system);
    ...
    //    Planet* neptune = new Planet(24.764, 17.2, 4484.350139, 5.43, 0.4 * PI, "Neptune", system);
        ...
        Planet* mercury = new Planet(2.440, 0.06, 57.149340, 2551, 0.33 * PI, "Mercury", system);
            ...
            Planet* jupiter = new Planet(71.492, 317.8, 778.009880, 697, 1.4 * PI, "Jupiter", system);
            Planet* saturn = new Planet(60.268, 95.2, 1426.283824, 516, 1.66 * PI, "Saturn", system);
            Planet* uranus = new Planet(25.559, 14.6, 2870.745626, 363, 0.8 * PI, "Uranus", system);
            Planet* neptune = new Planet(24.764, 17.2, 4498.350139, 289, 0.4 * PI, "Neptune", system);
